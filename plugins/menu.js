...
let handler = async (m, { conn, usedPrefix: _p, __dirname, args, command }) => {
  ...
  try {
    ...
    let fkon = { key: { fromMe: false, participant: `${m.sender.split`@`[0]}@s.whatsapp.net`, ...(m.chat ? { remoteJid: '6288224135175@s.whatsapp.net' } : {}) }, message: { contactMessage: { displayName: `${name}`, vcard: `BEGIN:VCARD\nVERSION:3.0\nN:;a,;;;\nFN:${name}\nitem1.TEL;waid=${m.sender.split('@')[0]}:${m.sender.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD` } } }
    ...
    await conn.sendMessage(m.chat, {
      ...
      contextInfo: {
        externalAdReply: {
          ...
          title: wm,
          thumbnailUrl: 'https://telegra.ph/file/713071860d48b8143a820.jpg',
          sourceUrl: 'https://www.instagram.com/infection.world',
          mediaType: 1,
